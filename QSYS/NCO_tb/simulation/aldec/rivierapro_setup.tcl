...
# ACDS 17.0 595 win32 2023.07.30.14:52:25
# ----------------------------------------
...
# ----------------------------------------
# If NCO_tb is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/NCO_tb_nco_ii_0_sin.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/aldec/asj_nco_aprid_dxx.v" -work nco_ii_0
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/NCO_tb_nco_ii_0.v"         -work nco_ii_0
