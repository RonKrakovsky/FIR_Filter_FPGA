...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/submodules/NCO_tb_nco_ii_0.v" -work nco_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/NCO_tb.vhd"                                 
fi
